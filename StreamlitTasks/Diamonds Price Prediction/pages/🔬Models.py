...
if(st.checkbox("Model Selected for Prediction")):
    st.subheader("We observed that Random Forest Regression Model gives the best evaluation score compared to the rest of the models. Therefore, we will use Random Forest Regression Model to predict the price of the Diamond!💎")
